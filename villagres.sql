...
--
-- Máquina: localhost
-- Data de Criação: 17-Jun-2015 às 03:40
...
--
-- Base de Dados: `villagres`
--
CREATE DATABASE IF NOT EXISTS `villagres` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `villagres`;
