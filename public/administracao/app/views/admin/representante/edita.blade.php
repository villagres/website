	...
	<div class="row">		
		...
		<div class="col-md-9">
			...
			@if(isset($representante))				
				...
				<div class="row">
					<div class="col-md-2">
						<span>Nome Ingles:</span>					
					</div>
					<div class="col-md-10">
						<input type="hidden" id="id" name="id" value="{{$representante['id']}}">
						<input type="text" id="nome_en" name="nome_en" value="{{$representante['nome_en']}}">
					</div>
				</div>
				<div class="row">
					<div class="col-md-2">
				...
				<div class="row">
					...
					<div class="col-md-10">
						<textarea name="informacoes" id="informacoes" rows="10" cols="80">			                
							<?php echo $representante['informacoes']; ?>
			            </textarea>
			            <script>
			                $(function(){
				...
				<div class="row">
					<div class="col-md-2"><span>Informações Ingles:</span></div>
					<div class="col-md-10">
						<textarea name="informacoes_en" id="informacoes_en" rows="10" cols="80">                
							<?php echo $representante['informacoes_en']; ?>
			            </textarea>
			            <script>
			                $(function(){
						...
						<?php 
							...
							$oFCKeditor->BasePath = "/fckeditor/";		
							$oFCKeditor->Value = $representante['informacoes_en'];		
							$oFCKeditor->Height = '300';
							echo $oFCKeditor->CreateHtml();
							*/
						?>
