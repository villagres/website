			...
			<form action="{{Route('admin.gravaLinha')}}" method="POST" enctype="multipart/form-data">
				@if(isset($linha))				
					...
					<div class="row">
						...
						@if($linha['imagem'] != '')
							<div class="col-md-1"><img src="{{'/img/linha/'.$linha['imagem']}}" alt="Linha"></div>
					...
					<div class="row">
						...
						<div class="col-md-1"><input type="checkbox" id="lancamento" name="lancamento" {{$linha['lancamento'] == 1 ? "checked" : ""}}></div>
					</div>
