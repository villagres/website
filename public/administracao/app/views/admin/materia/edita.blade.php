			...
			<form action="{{Route('admin.gravaMateria')}}" method="POST" enctype="multipart/form-data">
				@if(isset($materia))
					...
					<div class="row">
						...
						<div class="col-md-10">
							<input type="hidden" id name="id" value="{{$materia['id']}}">
							<input type="text" id="tituloDestaque_en" name="tituloDestaque_en" value="{{$materia['tituloDestaque_en']}}">
						</div>
					</div>
					<div class="row">
						...
						@if($materia['imagemDestaque'] != '') 
							<div class="col-md-1"><img src="{{'/img/materia/'.$materia['imagemDestaque']}}" alt="Matéria"></div>
					...
					<div class="row">
						...
						<div class="col-md-10"><input type="text" id="titulo_en" name="titulo_en" value="{{$materia['titulo_en']}}"></div>
					</div>
					<div class="row">
						...
						@if($materia['imagemMiniatura'] != '')
							<div class="col-md-1"><img src="{{'/img/materia/'.$materia['imagemMiniatura']}}" alt="Matéria"></div>
					...
					<div class="row">
						...
						<div class="col-md-10"><input type="text" id="olho_en" name="olho_en" value="{{$materia['olho_en']}}"></div>
					</div>
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-10">
							...
							<?php 
								...
								$oFCKeditor->BasePath = "/fckeditor/";		
								$oFCKeditor->Value = $materia['texto_en'];
								$oFCKeditor->Height = '300';
								echo $oFCKeditor->CreateHtml();
								*/
							?>																	
