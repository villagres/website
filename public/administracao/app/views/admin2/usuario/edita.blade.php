			...
			<form action="{{Route('admin.gravaUsuario')}}" method="POST">
				@if(isset($usuario))					
					<div class="row">
						...
						<div class="col-md-10"><input type="text" id="nome" name="nome" value="{{$usuario['nome']}}"></div>
					</div>
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-10"><input type="password" id="senha" name="senha" value="{{$usuario['password']}}"></div>
					</div>
					<div class="row">
