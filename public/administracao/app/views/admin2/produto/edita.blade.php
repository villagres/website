		...
		<div class="col-md-9">
			...
			@if(isset($produto))				
				...
				<div class="row">
					...
					<div class="col-md-10"><select name="legendas" id="legendas">
							<option value="">Selecione</option>
							@if(isset($legendas))
				...
				@if(isset($legendaProduto))
					@foreach($legendaProduto as $lp)
						<div class="row">
							<div class="col-md-5">
								<span>{{$lp->legenda}}</span>&nbsp;&nbsp;<a href="" class="fa fa-times"></a>
							</div>
						</div>
					@endforeach
				@endif
				...
				@if(isset($faceProduto))
					@foreach($faceProduto as $fp)
						<div class="row">
							<div class="col-md-5">
								<img src="{{'http://'.$_SERVER['SERVER_NAME'].'/img/produto/'.$fp->imagem}}" alt="">&nbsp;&nbsp;<a href="" class="fa fa-times"></a>
							</div>
						</div>
					@endforeach
				@endif
				...
				@if(isset($imagemProduto))
					@foreach($imagemProduto as $ip)
						<div class="row">
							<div class="col-md-5">
								<img src="{{'http://'.$_SERVER['SERVER_NAME'].'/img/produto/'.$ip->imagem}}" alt="">&nbsp;&nbsp;<a href="" class="fa fa-times"></a>
							</div>
						</div>
					@endforeach
				@endif
