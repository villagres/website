<?php
	...
	class Configurator{
		 ...
		 *
		 *  The target object is expected to have a setter method for each option passed. By convention getters and
		 ...
		 *  @param boolean $tryCall When true and $target has a __call() function, try call if no set
		 *  @return void Nothing
		 */
